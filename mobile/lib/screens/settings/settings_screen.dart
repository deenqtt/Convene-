      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(children: [
              const AvatarWidget(email: 'alex@nexabrick.com', size: 48),
              const SizedBox(width: 14),
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                const Text('Alex Rivera', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15)),
                const Text('alex@nexabrick.com', style: TextStyle(color: AppColors.textSecondary, fontSize: 12)),
                ...
                Container(
                  ...
                  child: const Text('Admin', style: TextStyle(fontSize: 10, color: AppColors.blueLight, fontWeight: FontWeight.bold)),
                ),
              ])),
          ...
          const Text('Meeting App v1.0.0 · by Nexus',
