          ...
          children: [
            ...
            Row(
              ...
              children: [
                _label('PARTICIPANTS'),
                Row(children: const [
                  Icon(Icons.person_add_outlined, size: 14, color: AppColors.blueLight),
                  SizedBox(width: 4),
                  Text('Add Contacts', style: TextStyle(fontSize: 12, color: AppColors.blueLight, fontWeight: FontWeight.w600)),
                ]),
              ],
            ),
            const SizedBox(height: 8),
            _inputField(hint: 'Add guest email...'),
            const SizedBox(height: 16),
